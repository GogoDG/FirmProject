...
public class ControlRepTab extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ControlRepTab() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ControlRepTab.class.getResource("/icons/facade.png")));
		setTitle("Facade");	
		...
		btnAdd = new JButton("");
		btnAdd.setIcon(new ImageIcon(ControlRepTab.class.getResource("/icons/plus.png")));
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query = "SELECT * FROM sales_rep WHERE username = ?";
					String query2 = "INSERT INTO sales_rep values (?, ?, ?, ?, ?)";
					String query3 = "SELECT * FROM sales_rep";
		...
		btnEdit = new JButton("");
		btnEdit.setIcon(new ImageIcon(ControlRepTab.class.getResource("/icons/edit.png")));
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query = "SELECT * FROM sales_rep where id = ?";
					lblTXT.setVisible(false);
					StaffContentsEditor et = new StaffContentsEditor();
					et.displayStaffContents(query, textID, textFname, textLname, textUname, textPass);
		...
		btnDelete.setIcon(new ImageIcon(ControlRepTab.class.getResource("/icons/minus.png")));
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query = "DELETE FROM sales_rep where id = ?";
					String query2 = "SELECT * FROM sales_rep";
		...
		btnUpdate.setIcon(new ImageIcon(ControlRepTab.class.getResource("/icons/refresh.png")));
		btnUpdate.setVisible(false);
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query = "UPDATE sales_rep SET firstname = ?, lastname = ?, username = ?, password = ? where id = ?";
					String query2 = "SELECT * FROM sales_rep";
					StaffContentsEditor et = new StaffContentsEditor();
					et.editStaffEntry(query, query2, textID, textFname, textLname, textUname, textPass, lblTXT, btnUpdate, table);
				} catch (Exception e) {
					JOptionPane.showMessageDialog(null, "Insert Valid ID!");
				}
			}
		...
		btnBack.setIcon(new ImageIcon(ControlRepTab.class.getResource("/icons/back.png")));
